...
if (!roomId || !conversationId) {
  ...
  // Ver device/app.js — único slider de los tres que dispara algo real:
  // completar "Emergencia SOS" pasa a la pantalla de llamada SOS en
  // curso y resincroniza /control.
